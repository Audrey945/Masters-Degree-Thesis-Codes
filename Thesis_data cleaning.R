...
setwd("C:/Users/Audrey/Data analysis/Thesis_final codes")

#---------------------------------------------#
#Read DHS data into R
#install.packages("haven")  #install package
library(haven) #load package
ZWDHS1988 <- read_dta("C:/Users/Audrey/DHS data/ZW_1988_DHS_03012021_1233_148664/ZWIR01DT/ZWIR01FL.DTA") #1988 data
ZWDHS1994 <- read_dta("C:/Users/Audrey/DHS data/ZW_1994_DHS_03012021_1234_148664/ZWIR31DT/ZWIR31FL.DTA") #1994 data
ZWDHS1999 <- read_dta("C:/Users/Audrey/DHS data/ZW_1999_DHS_03012021_1234_148664/ZWIR42DT/ZWIR42FL.DTA") #1999 data
ZWDHS2005_06 <- read_dta("C:/Users/Audrey/DHS data/ZW_2005-06_DHS_03012021_1235_148664/ZWIR52DT/ZWIR52FL.DTA")  #2005-6 data
ZWDHS2010_11 <- read_dta("C:/Users/Audrey/DHS data/ZW_2010-11_DHS_03012021_1236_148664/ZWIR62DT/ZWIR62FL.DTA")  #2010-11 data
ZWDHS2015 <- read_dta("C:/Users/Audrey/DHS data/ZW_2015_DHS_03012021_1231_148664/ZWIR72DT/ZWIR72FL.DTA")   #2015 data
...
path <- "C:/Users/Audrey/Data analysis/Thesis_final codes" 
newfolder <- "Study pop data"
dir.create(file.path(dirname(path),newfolder)) #create folder to save datasets
write.csv(as.data.frame(mydata1988),"C:/Users/Audrey/Data analysis/Study pop data/stdy_pop1988.csv") #1988 data
write.csv(as.data.frame(mydata1994),"C:/Users/Audrey/Data analysis/Study pop data/stdy_pop1994.csv") #1994 data
write.csv(as.data.frame(mydata1999),"C:/Users/Audrey/Data analysis/Study pop data/stdy_pop1999.csv") #1999 data
write.csv(as.data.frame(mydata2005),"C:/Users/Audrey/Data analysis/Study pop data/stdy_pop2005.csv") #2005 data
write.csv(as.data.frame(mydata2010),"C:/Users/Audrey/Data analysis/Study pop data/stdy_pop2010.csv") #2010 data
write.csv(as.data.frame(mydata2015),"C:/Users/Audrey/Data analysis/Study pop data/stdy_pop2015.csv") #2015 data
...
write.csv(as.data.frame(mydata1988_filter3%>%select(caseid,ccluster,sstrata,weight,v012,
          ...
          "C:/Users/Audrey/Data analysis/CP use data/DHS1988.csv") #1988 data
...
write.csv(as.data.frame(mydata1994_filter3%>%select(caseid,ccluster,sstrata,weight,v012,
          ...
          "C:/Users/Audrey/Data analysis/CP use data/DHS1994.csv") 
...
write.csv(as.data.frame(mydata1999_filter3%>%select(caseid,ccluster,sstrata,weight,v012,
          ...
          "C:/Users/Audrey/Data analysis/CP use data/DHS1999.csv") 

write.csv(as.data.frame(mydata2005_filter3%>%select(caseid,ccluster,sstrata,weight,v012,
                                                    fp_use,age_grp,residence,region,v101,
                                                    edu_level,mrt_status,v218,parity,v106,
                                                    fp_knowledge,v602,kids_desire,v714,cp_agediff,v511)),
          "C:/Users/Audrey/Data analysis/CP use data/DHS2005.csv") 
...
write.csv(as.data.frame(mydata2010_filter3%>%select(caseid,ccluster,sstrata,weight,v012,
                                                    ...
                                                    fp_knowledge,v602,kids_desire,v714,cp_agediff,v511)),
          "C:/Users/Audrey/Data analysis/CP use data/DHS2010.csv") 

write.csv(as.data.frame(mydata2015_filter3%>%select(caseid,ccluster,sstrata,weight,v012,
                                                    fp_use,age_grp,residence,region,v101,
                                                    edu_level,mrt_status,v218,parity,v106,
                                                    fp_knowledge,v602,kids_desire,v714,cp_agediff,v511)),
          "C:/Users/Audrey/Data analysis/CP use data/DHS2015.csv") 
...
dir.create(file.path(dirname(path),newfolder)) #create folder to save datasets
write.csv(as.data.frame(DHS1988_MC),"C:/Users/Audrey/Data analysis/CP method choice data/DHS1988_MC.csv") 
write.csv(as.data.frame(DHS1994_MC),"C:/Users/Audrey/Data analysis/CP method choice data/DHS1994_MC.csv") 
write.csv(as.data.frame(DHS1999_MC),"C:/Users/Audrey/Data analysis/CP method choice data/DHS1999_MC.csv") 
write.csv(as.data.frame(DHS2005_MC),"C:/Users/Audrey/Data analysis/CP method choice data/DHS2005_MC.csv") 
write.csv(as.data.frame(DHS2010_MC),"C:/Users/Audrey/Data analysis/CP method choice data/DHS2010_MC.csv") 
write.csv(as.data.frame(DHS2015_MC),"C:/Users/Audrey/Data analysis/CP method choice data/DHS2015_MC.csv") 
...
dir.create(file.path(dirname(path),newfolder)) #create folder to save datasets
write.csv(as.data.frame(CPNEEDS1994),"C:/Users/Audrey/Data analysis/CP Need data/CPNEED1994.csv") 
write.csv(as.data.frame(CPNEEDS1999),"C:/Users/Audrey/Data analysis/CP Need data/CPNEED1999.csv") 
write.csv(as.data.frame(CPNEEDS2005),"C:/Users/Audrey/Data analysis/CP Need data/CPNEED2005.csv") 
write.csv(as.data.frame(CPNEEDS2010),"C:/Users/Audrey/Data analysis/CP Need data/CPNEED2010.csv") 
write.csv(as.data.frame(CPNEEDS2015),"C:/Users/Audrey/Data analysis/CP Need data/CPNEED2015.csv") 
...
newfolder <- "AFS data"
dir.create(file.path(dirname(path),newfolder)) #create folder to save datasets
write.csv(as.data.frame(AFS_filter1988),"C:/Users/Audrey/Data analysis/AFS data/AFS1988.csv") #1988 data
write.csv(as.data.frame(AFS_filter1994),"C:/Users/Audrey/Data analysis/AFS data/AFS1994.csv") #1994 data
write.csv(as.data.frame(AFS_filter1999),"C:/Users/Audrey/Data analysis/AFS data/AFS1999.csv") #1999 data
write.csv(as.data.frame(AFS_filter2005),"C:/Users/Audrey/Data analysis/AFS data/AFS2005.csv") #2005 data
write.csv(as.data.frame(AFS_filter2010),"C:/Users/Audrey/Data analysis/AFS data/AFS2010.csv") #2010 data
write.csv(as.data.frame(AFS_filter2015),"C:/Users/Audrey/Data analysis/AFS data/AFS2015.csv") #2015 data
#=========================================================================================#
...
#MICS data
MICs_2009 <- read_sav("C:/Users/Audrey/Unicef MICs data/Zimbabwe 2009 MICS_Datasets/Zimbabwe_Datasets/Zimbabwe MIMS 2009 SPSS Datasets/wm.sav")
View(MICs_2009)
MICs_2014 <- read_sav("C:/Users/Audrey/Unicef MICs data/Zimbabwe 2014 MICS_Datasets/Zimbabwe_MICS5_Datasets/Zimbabwe MICS 2014 SPSS Datasets/wm.sav")
View(MICs_2014)

#DHS data
DHS2010 <- read.csv("C:/Users/Audrey/Data analysis/Study pop data/stdy_pop2010.csv")[,-1] #2010 data
DHS2015 <- read.csv("C:/Users/Audrey/Data analysis/Study pop data/stdy_pop2015.csv")[,-1] #2015 data
...
dir.create(file.path(dirname(path),newfolder)) #create folder to save datasets
write.csv(as.data.frame(MICs2009),"C:/Users/Audrey/Data analysis/MICS vs DHS data/Sty_MICs2009.csv") #2009 data
write.csv(as.data.frame(MICs2014),"C:/Users/Audrey/Data analysis/MICS vs DHS data/Sty_MICs2014.csv") #2014 data
...
#------------------------------------#
#SAVE DATA IN EXCEL                            
write.csv(as.data.frame(MICs2009_filter1),"C:/Users/Audrey/Data analysis/MICS vs DHS data/MICs2009.csv") # MICS 2009 data
write.csv(as.data.frame(MICs2014_filter2),"C:/Users/Audrey/Data analysis/MICS vs DHS data/MICs2014.csv") # MICS 2014 data
write.csv(as.data.frame(DHS2010_filter1),"C:/Users/Audrey/Data analysis/MICS vs DHS data/DHS2010_COMP.csv") # DHS2010 data
write.csv(as.data.frame(DHS2015_filter2),"C:/Users/Audrey/Data analysis/MICS vs DHS data/DHS2015_COMP.csv") # DHS2015 data
#=========================================================================================#
